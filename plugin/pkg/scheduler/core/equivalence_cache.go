...
func (ec *EquivalenceCache) InvalidateCachedPredicateItemForPodAdd(pod v1.Placeable, nodeName string) {
...
func (ec *EquivalenceCache) getHashEquivalencePod(pod v1.Placeable) (uint64, bool) {
