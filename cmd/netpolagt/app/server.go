...
func UnsecuredNetworkPolicyAgentConfig(s *options.NetworkPolicyAgent) (*NetworkPolicyAgenttConfig, error) {
...
// will be ignored.
func Run(s *options.NetworkPolicyAgent, kcfg *KubeletConfig) error {
	err := run(s, kcfg)
	if err != nil {
...
func InitializeTLS(s *options.NetworkPolicyAgent) (*server.TLSOptions, error) {
...
type NetworkPolicyAgentConfig struct {
	...
	ConfigFile                     string
	NeutronClient                  dockertools.DockerInterface
