...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&o.config.SelfLookupTimeout, "self-lookup-timeout", o.config.SelfLookupTimeout, "How long the proxy waits for its Node object to become defined")
}
