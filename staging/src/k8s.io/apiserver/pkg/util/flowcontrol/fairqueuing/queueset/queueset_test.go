...
func TestContextCancel(t *testing.T) {
	...
	req1, _ := qs.StartRequest(ctx1, &fcrequest.Width{Seats: 1}, 1, "", "fs1", "test", "one", queueNoteFn1)
	if req1 == nil {
	...
	go func() {
		idle1 = req1.Finish(func() {
			...
			req2, idle2a := qs.StartRequest(ctx2, &fcrequest.Width{Seats: 1}, 2, "", "fs2", "test", "two", queueNoteFn2)
			if idle2a {
