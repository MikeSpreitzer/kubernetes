...
func TestPrintFlowSchema(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// Columns: Name, PriorityLevelName, MatchingPrecedence, DistinguisherMethod, MatchesAll, MissingPL, Age
			...
			// Columns: Name, PriorityLevelName, MatchingPrecedence, DistinguisherMethod, MatchesAll, MissingPL, Age
			expected: []metav1.TableRow{{Cells: []interface{}{"some-matcher", "allee", int32(0), "ByNamespace", false, "True", "5m"}}},
		}, {
			fs: flowcontrol.FlowSchema{
				ObjectMeta: metav1.ObjectMeta{
					Name:              "exempt",
