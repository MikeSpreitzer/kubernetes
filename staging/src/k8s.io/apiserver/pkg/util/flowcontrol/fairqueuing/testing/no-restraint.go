...
func (noRestraintFactory) BeginConstruction(qCfg fq.QueuingConfig, intPair fq.WindowedIntegratorPair) (fq.QueueSetCompleter, error) {
...
func (noRestraint) StartRequest(ctx context.Context, hashValue uint64, fsName string, descr1, descr2 interface{}, queueNoteFn fq.QueueNoteFn) (fq.Request, bool) {
